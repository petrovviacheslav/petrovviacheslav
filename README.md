...
1. [Web platform with registration of hitting the target](http://parzi.ru/main)

   Веб платформа для регистрации попадания точек, использующая двойную аутентификацию по почте для входа в аккаунт

2. [Application for registration and interaction with data (client.jar + server.jar)](https://github.com/sub-myitmo/lab8-java/tree/main)

   Приложение с графическим интерфейсом для клиентской части, производящее взаимодействие с серверной на основе протокола UDP

3. [API-service to provide subscriber information](https://github.com/petrovviacheslav/subscriber-data-tracking/tree/main)

   Бэкенд приложение для формирования и представления CDR-отчётов, CDR-записей, UDR-записей. Использовалась Spring Framework, H2 Database, код покрыт тестами на 75%, используется встроенное CI/CD (github workflow)
   
4. [Myitmo](https://github.com/petrovviacheslav/myitmo)

   Сборник всех работ с моего обучения на специальности СППО в НИУ ИТМО
...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/spring/spring-original-wordmark.svg" title="spring" height="40"/>&nbsp;
...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/debian/debian-plain-wordmark.svg" title="debian" width="40" heignt="40 "/>&nbsp;
...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/datagrip/datagrip-original.svg" title="datagrip" width="40" height="40"/>&nbsp;
...
<img src="https://img.shields.io/badge/WildFly-000000?style=for-the-badge&logo=wildfly&logoColor=white" height="35" alt="Wildfly"/>&nbsp;
<img src="https://img.shields.io/badge/Tomcat-F8DC75?style=for-the-badge&logo=apachetomcat&logoColor=black" height="35" alt="Tomcat"/>&nbsp;
